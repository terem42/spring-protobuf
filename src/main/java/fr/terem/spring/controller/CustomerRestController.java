...
public class CustomerRestController {
    ...
    @GetMapping(value = "/customers-protobuf", consumes = "application/json", produces = "application/json")
    public List getCustomers() {
        return customerDAO.list();
    }

    @PostMapping(value = "/customers-protobuf", consumes = "application/json", produces = "application/json")
